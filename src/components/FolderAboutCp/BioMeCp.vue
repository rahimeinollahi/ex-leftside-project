<template>
    <div class="continer">
        <h2>City</h2>
        <p>He was born in the city of Tabriz</p>
           <hr class="bg-danger px-3">
        <h4 class="">Another info</h4>
...
@font-face {
    ...
    src: url('../../assets/fonts/AlexandriaFLF-BoldItalic.ttf');
}
*{font-family: 'bio-font';}

h2,h4,h5{
  text-shadow: 2px 3px 15px red,
  5px 0 12px blue;
}
p{
    text-align: justify;
